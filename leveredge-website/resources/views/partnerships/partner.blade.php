...
@section('content')
        ...
        <div class="container mt-0 mb-0 pt-1 pb-1">
            <div class="row">
                <div class="col-12 text-center text-white">
                    {!! $landing_page->message_in_blue_bar !!}
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="jumbotron mt-0 mb-0 pt-0 pb-0 bg-white" id="partnership-hero">
        <div class="container">
                ...
                <div class="col-12 col-md-6 mt-5 mt-md-0">
                    <div class="card negotiated-deal-shadow border-0">
                        <div class="card-body">
                            ...
                            @if($landing_page->logo)
                                <img
                                    src="{{ storage_public_url($landing_page->logo) }}"
                                    alt="Logo"
            ...
            @if($landing_page->quote)
                <div class="row mt-5 justify-content-center">
                    <div class="col-12">
                        <blockquote class="blockquote">
                            <p class="mb-0">{{ $landing_page->quote }}</p>
                            <footer class="blockquote-footer mt-3"><cite
                                    title="Source Title">{{ $landing_page->quote_author }}</cite></footer>
                        </blockquote>
                    </div>
                </div>
            @endif
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6">
                    ...
                    <p>
                        We bring a large amount of business to lenders and in return they offer lower interest rates for
                        our members.
                    </p>
                    <p class="mt-3">
                    ...
                    <p>
                        Beyond rates, we evaluate a lender's customer service and ease of application when selecting a
                        lender.
                    </p>
                    ...
                    <p>
                        We’re here to answer any questions along the way and ensure members receive rates and terms that
                ...
                <div
                    class="col-12 col-md-4 offset-md-2 text-center d-flex justify-content-center flex-column mt-5 mt-md-0">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <h4 class="mt-4 text-center pb-3">Learn how we used group buying power to negotiate better student
                        loans.</h4>

                    <div class="card-deck mt-5" id="how-it-works-new">
                        <div class="card">
                            <div class="card-body text-center">
                                <img src="{{ url('/img/icons/teamwork.svg') }}" class="mt-3 img-fluid"
                                     style="max-height: 80px;">
                                <h2 class="mt-4">STUDENTS SIGN UP</h2>
                                <p class="mt-3 pr-1 pl-1">
                                    Students from top tier programs sign up to Juno by providing essential
                                    information.
                                </p>
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                <img src="{{ url('/img/icons/relationship.svg') }}" class="mt-3 img-fluid"
                                     style="max-height: 80px;">
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                <img src="{{ url('/img/icons/data-analysis.svg') }}" class="mt-3 img-fluid"
                                     style="max-height: 80px;">
                        ...
                        <div class="card highlight-card">
                            <div class="card-body text-center">
                                <img src="{{ url('/img/icons/loan-money.svg') }}" class="mt-3 img-fluid"
                                     style="max-height: 80px;">
                                <h2 class="mt-4">LOANS OFFERED</h2>
                                <p class="mt-3 pr-1 pl-1">
                                    Members get exclusive access to the Juno deal, including substantial rate
                                    discounts.
                                </p>
                                <p class="mt-md-5 mt-3 text-blue completed-text">
                                    <a href="{{ url('/negotiated-in-school-deal') }}" class="btn btn-primary">View
                                        Negotiated Deals</a>
                                </p>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8 col-lg-6 text-center">
                        ...
                        <p class="text-light mt-3">
                            Joining Juno is free, takes less than 2 minutes and gets you access to the deals
                            negotiated by Juno.
                        </p>
                            ...
                            <div class="form-group text-left mb-0">
                                <div class="input-group mb-3">
                                    ...
                                    <div class="input-group-append">
                                        <button id="submit-enroll-form-button" class="btn btn-light">Get Started
                                        </button>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6">
                    ...
                    <div class="separator"></div>
                    <p class="mt--3">Last Fall, the Juno team helped 400+ students get loans totaling over $25M at
                        low interest rates. Students saved more than $3.3M compared to federal options.</p>
...
@section('legal-disclosures')
    ...
    <p>We cannot guarantee that the rates and terms that are offered to you as part of a negotiation group are actually
        better than other options available to you.</p>
    <p>We cannot guarantee the accuracy of our calculators.</p>
@endsection


@push('footer-scripts')
    <!-- This sets the affiliate to partner --->
    <img src="{{ url('/tracking-pixel.png?affiliate=' . $landing_page->partner_profile->user->referral_code) }}">
@endpush
