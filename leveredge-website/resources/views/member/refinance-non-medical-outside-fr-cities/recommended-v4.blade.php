        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <h6 class="text-center">
                    We'll send you a signing bonus when you take a loan. <sup class="foot-note-marker">*</sup>
                </h6>
        ...
        <div class="container">
            <div class="row justify-content-center mt-4">
                <div class="col-12 col-md-6 px-0 px-lg-3">
                    @include('member.deal.earnest-refinance._display_reward_amount_experiment_earnest_refinance_card')
                </div>
                <div class="col-12 col-md-6 px-0 px-lg-3">
                    @include('member.deal.splash-refinance._display_reward_amount_experiment_splash_card')
                </div>
            </div>
        </div>
    </div>
