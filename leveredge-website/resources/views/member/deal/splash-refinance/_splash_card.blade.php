...
@push('custom-disclaimers')
    <p class="text-footer-disclaimer">7 - Terms and conditions apply. Only new customers are eligible for the bonus. If member is eligible for bonus, $300 will be mailed from Splash directly, and $300 will be provided by Juno digitally. Receipt may take up to 4 months, following the member filling out the required form. APR may include auto pay discount. See Splash Financial for full details.</p>
@endpush
