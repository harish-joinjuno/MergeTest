            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <h3 class="h3-class deal-heading mt-4 text-center">
                        In addition, as a reward for being our member, you will receive 0.5% of the loan amount.<sup class="foot-note-marker">7</sup>
                    </h3>
                    <p class="text-center">
                        <a target="_blank" href="{{ url('/member/deal/'.\App\Deal::DEAL_EARNEST_REFINANCE_WITH_REWARDS_20_OTHER_STATES_SLUG.'/hand-off') }}" class="btn-voila cta mt-4">Check my rate</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="frow">
                    @include('member.deal-partials.rate-table',[
                        ...
                        'cta_link' => url('/member/deal/'.\App\Deal::DEAL_EARNEST_REFINANCE_WITH_REWARDS_20_OTHER_STATES_SLUG.'/hand-off'),
                        'variable_rates' => [
                            ['term' => '5 Years', 'APR' => 'Starting at 1.99%'],
                        ],
                        'fixed_rates' => [
                            ['term' => '5 Years', 'APR' => 'Starting at 3.19%'],
                        ],
                        'notes_below_rates' => [
                            'APRs include 0.25% Auto Pay discount <sup class="foot-note-marker">2</sup>',
...
@push('custom-disclaimers')
    ...
    <p class="text-footer-disclaimer">
        6 - APRs are independent of the Juno cash rewards. Your cash reward is a one-time payment of 0.5% of
        your Earnest Private Student loan amount (for example on a $60k loan your reward would be $300).
    </p>
@endpush
