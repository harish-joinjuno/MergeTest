...
@section('content')
    ...
    @php
        $heading = "We've negotiated a discounted student loan options for grad students";
    @endphp
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-6 text-center text-lg-left">
                    <div class="title mt-4">
                        <h4>LeverEdge Rewards</h4>
                    </div>
                    <h3 class="mt-5 primary h3-class">
                        LeverEdge gives 0.5% of your loan amount back to you for taking a loan via LeverEdge*
                    </h3>
                    ...
                    <div class="faq-half mt-5">
                        ...
                        <div class="inner-content">
                            <div class="question">
                                When will I receive LeverEdge rewards?
                                <span class="icon"></span>
                            </div>
                            <div class="answer">
                                <p>
                ...
                <div class="frow">
                    ...
                    <div class="loan-details" data-scroll>
                        ...
                        <div class="loan-points">
                            <ul>
                                <li><span>LeverEdge Cash Reward</span><br>At least 0.50% of Loan Amount</li>
                                <li><span>No early repayment penalty</span></li>
                                <li><span>Up to 4.00% Lower Rate</span> <br>(compared to directly applying to the lender)</li>
