...
@section('content')
    ...
    <div class="container">
        <div class="row">
                ...
                <form method="post" action="{{ url('/scholarship/' . $scholarship->slug) }}">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 text-center">
                            <p class="small">
                                {!! $terms_text ?? 'We don\'t sell your information to anyone. Scroll down to learn more.' !!}
                            </p>
                        </div>
                    </div>
                </form>
            ...
            <div class="right-image col-12 col-sm-8 offset-sm-1 col-lg-4 mb-5 pl-4 position-relative pt-5">
                <img
    ...
    <div class="container pt-5 mt-5 pt-sm-0 mt-sm-0" style="height:0;">
        <div class="row text-center text-sm-right" style="transform:translateY(-75%)">
            <div class="col">
                <img
                    src="{{ asset('/img/students-under-tree.png') }}"
                    alt="Flavor Image"
                    aria-hidden="true"
    ...
    @include('landing-pages.partials._press-banner', [
        'hideFormerlyText' => true,
    ])

    <div class="container-fluid bg-light">
        <div class="container narrow text-center py-5">
            <h2>
                {!! $cta_heading !!}
            </h2>
        ...
        <div class="container pt-5" style="height:0;">
