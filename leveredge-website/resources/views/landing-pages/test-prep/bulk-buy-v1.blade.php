    ...
    >
        ...
        <div class="container-fluid px-0 bg-light py-5">
            <div class="container text-center my-5">
                ...
                @endif
                <div class="row justify-content-center mt-5 goal-rings">
                    @foreach($goals as $goal)
                        @if($goal['discount'] > 30)
                            <div class="col-12 col-sm-6 col-lg-3 goal-ring-wrap" data-min="{{ $goal['min'] }}">
                                @component('landing-pages.partials._progress-ring', [
                                    'currentProgress' => ($completed_applications / max($goal['min'], 1)) * 100
                                ])
                                    <h5
                                        class="position-absolute d-flex flex-column align-items-center
                                    justify-content-center px-2 text-primary"
                                ...
                                <p>
                                    {{
                                        $completed_applications >= $goal['min']
                                        ? 'Unlocked'
                                        : ($goal['min'] - $completed_applications) . ' people to go'
                                    }}
                                </p>
                            </div>
                        @endif
