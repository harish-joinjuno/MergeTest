...
@section('base-content')
    ...
    <div class="container py-5">
        <div class="row mt-5 py-5">
            <div class="col-12 col-md-8">
                ...
                <p>Join for free and get an exclusive 1% APR discount off advertised rates.</p>
            </div>
    ...
    @if(!empty($rates))
        @include('landing-pages.partials._rates-table', [
            ...
            'aprFootNote' => \App\Facades\FootNote::addFootNote(\App\FootNote::EARNEST_SLO_APR_FOOTNOTE),
            ...
            <div class="row">
                <div class="col-12 mb-5">
                    ...
                    <p>
                        ...
                        <br><br>
                        We negotiate exclusive deals with our lending partners. Our undergraduate deal offers a
                        1% rate reduction, which you won’t see anywhere else.
                    </p>
                </div>
                <div class="col-12 mb-5">
                ...
                <div class="col-12 mb-5">
                    ...
                    <p>
                        ...
                        That’s the difference of $1,479.89 – $32,643.6 through Juno versus $34,123.49 through
                        Parent PLUS.*
                        <br><br>
                        <small class="text-muted font-italic">
                            *using a loan amount of $25,600 (average for Parent PLUS) over
                            ten years. Additional terms apply.
                        </small>
                    </p>
                </div>
                <div class="col-12">
