            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-lg-8 px-lg-5 mb-3 mb-sm-5">
                    <div class="row mb-5">
                        ...
                        <div class="col">
                            <h4 class="mb-3">
                                We’re negotiating for you right now
                            </h4>
                            ...
                            @include('landing-pages.partials._share-links', [
                                'facebookShareMessage' => 'Hey everyone, wanted to share an opportunity to save us
                                all some money on our monthly car payments for free: an organization called Juno will
                                go negotiate with banks and lenders to get an exclusive deal for everyone in the
                                group. It’s no commitment, no obligation, they’ve done this with student loans and
                                are now doing it for auto loans. The more people we have in the group the better
                                the deal will be. We just need ' . $difference . ' more people until they give it
                                a shot:',
                                'twitterShareMessage' => 'If anyone is looking to take advantage of today’s low
                                interest rates to lower their monthly car payments, consider joining the Juno group
                                for free so they can negotiate a deal on everyone’s behalf:',
                                'shareLink' => url('/loans/auto-refinance?grow=' . user()->referral_code ),
                            ])
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-8 col-lg-4 mb-5 px-0 position-relative">
                    @if(!empty($shareImage) && $shareImage === 'visualized')
                        @include('landing-pages.post-auth.share-images._visualized')
                    @elseif(!empty($shareImage) && $shareImage === 'leaderboard')
                        @include('landing-pages.post-auth.share-images._leaderboards')
                    @else
                        @include('landing-pages.post-auth.share-images._thank-you')
                    @endif
                </div>
            </div>
        </div>
