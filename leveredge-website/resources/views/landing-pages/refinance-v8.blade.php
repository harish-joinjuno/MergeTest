...
@section('base-content')
    ...
    <div
        class="container narrow mb-n4 py-5"
    ...
    >
        <div class="row justify-content-center align-items-center mt-5 py-5">
            <div class="col-12 text-center mb-5">
                ...
                <a
                    href="{{ url('/register') }}"
                    class="btn btn-secondary rounded-pill px-5 font-weight-bold mb-5"
                >
                    Check my rate
                </a>
            </div>
        ...
        <div class="container narrow px-0 my-5">
            <div class="row">
                ...
                <div class="col-12 col-lg-8 offset-lg-2 p-0 d-flex flex-column justify-content-center mb-5">
                    <div class="widescreen video-box">
                ...
                <div class="col-12 mb-5">
                    ...
                    <ul class="row list-unstyled text-center">
                        <li class="col mb-2">
                            <h2 class="text-primary">$502,121+</h2>
                            <p>in cash back earned by our community in 2020</p>
                        </li>
                        <li class="col mb-2">
                            <h2 class="text-primary">40,000+</h2>
                            <p>members</p>
                        </li>
                        <li class="col mb-2">
                            <h2 class="text-primary">$40,000,000+</h2>
                            <p>in savings compared to federal rates</p>
                        </li>
                    </ul>
                </div>
                <div class="col-12 mb-5">
                ...
                <div class="col-12 mb-5">
                    ...
                    <p>
                        ...
                        now, federally held student loans aren’t incurring any interest until at least October 1, 2021. As a result, borrowers with federally held loans are largely waiting until then before
                        considering refinancing.
                        <br><br>
                        For private loan borrowers, there’s little downside associated with refinance, and a large
                        potential upside in terms of savings, and reducing your monthly payment. If you have both federal and private, know that you may consider only refinancing private loans at this time, which is an option that many Juno members opt for. You're free to refinance whichever assortment of loans you choose without being forced to refinance all at once.
<br><br>
                ...
                <div class="col-12 mb-5">
                    ...
                    <p>
                        Earnest is owned by Navient, one of the largest student loan servicers in America. While
                        they operate as a separate unit, they have the backing and security of an established servicer.
...
You may want to compare Earnest and Splash to see who offers you the best rates and cash back combination, especially since both let you view custom rates without a hard credit check.
                        ...
                        to $1,000 total<sup class="foot-note-marker">6</sup>. They also have low rates, and a product that analyzes your risk based off a
                        variety of factors (called merit-based lending).
                        <br><br>

                        <strong>Rates:</strong> Fixed starting at 2.98%<sup class="foot-note-marker">2,3</sup>
                        APR, Variable starting at 1.99%<sup class="foot-note-marker">2,3</sup> APR including autopay discount
                        <br>
                        <strong>Cashback:</strong> Up to $1,000 via Juno and Earnest<sup class="foot-note-marker">6</sup>
                    </p>
                </div>
                <div class="col-12 mb-5">
                    ...
                    <p>
                        ...
                        available.
                        <br><br>
                        In comparison to Earnest, their starting variable rates are a bit lower, but the potential cash back
                        is also lower. If you’re shopping around these are both factors to consider depending on loan
                        amount and your preferences.
                        <br><br>
                        <strong>Rates:</strong> Fixed starting at 2.98%<sup class="foot-note-marker">2,3,*</sup>
                        APR, Variable starting at 1.89%<sup class="foot-note-marker">2,3,*</sup> APR. May include autopay discount.
                        <br>
                        <strong>Cashback:</strong> Up to $600 via Juno and Splash with loans above
                        $50,000<sup class="foot-note-marker">7,*</sup>
                    </p>
                </div>
                <div class="col-12 mb-5">
                ...
                <div class="col-12 mb-5">
                    <h4 class="green-underline mb-4">What are the typical questions?</h4>
                    <p>
                        If you can answer these ten questions, you can probably go get customized
                        rates within 5 minutes:
                    </p>
                    <ol>
                        <li>Name</li>
                        <li>Email Address</li>
                ...
                <div class="col-12 mb-5">
                    <h4 class="green-underline mb-4">Is now a good time to refinance private student loans?</h4>
                    <img
                        src="{{ asset('/img/refi-rates-over-time.png') }}"
                        alt="Refinance Rates Through Time"
                        class="img-fluid"
                    >
                </div>
                <div class="col-12 mb-5">
                    ...
                    <p>
                        ...
                        <br><br>
                        <strong class="mr-2">×</strong> With Earnest, you can only refinance loans already in your name as the primary borrower. If your parent is the primary borrower, the original lender may
    ...
    @push('custom-disclaimers')
        ...
        <p class="text-footer-disclaimer">
            1 - Loan Cost Examples: These examples provide estimates based on payments beginning immediately upon
        ...
        <p class="text-footer-disclaimer">
            2 - Actual rate and available repayment terms will vary based on your credit profile. Fixed rates range
        ...
        <p class="text-footer-disclaimer">
            3 - You can take advantage of the Auto Pay interest rate reduction by setting up and maintaining
        ...
        <p class="text-footer-disclaimer">
            4 - Earnest does not charge fees for origination, late payments, or prepayments. Florida Stamp Tax:
        ...
        <p class="text-footer-disclaimer">
          5 - Earnest Loans are made by Earnest Operations LLC or One American Bank, Member FDIC. Earnest Operations
            LLC, NMLS #1204917, 535 Mission St, Suite 1663 San Francisco, CA 94105. CA Financing Law License #6054788 Visit earnest.com/licenses
        ...
        <p class="text-footer-disclaimer">
            ...
            The information you provide Splash is an inquiry to determine whether we or our lenders can make a loan offer that meets your needs. Not all information is required by all lending partners were you to submit an application directly on their website. If we or any of our lending partners has an available loan offer for you, you will be invited to submit a loan application to the lender for its review. We do not guarantee that you will receive any loan offers or that your loan application will be approved. Offers are subject to credit approval and are available only to U.S. citizens or permanent residents who meet applicable underwriting requirements. Not all borrowers will receive the lowest rates, which are available to the most qualified borrowers. Participating lenders, rates and terms are subject to change at any time without notice.
            To check the rates and terms you qualify for, Splash Financial conducts a soft credit pull that will not affect your credit score. However, if you choose a product and continue your application, the lender will request your full credit report from one or more consumer reporting agencies, which is considered a hard credit pull and may affect your credit.
            Savings over the life of your loan assumes same or shorter loan terms and/or interest rates on your refinance, and may not be representative of your situation. Actual savings, if any, may vary based on interest rates, balances, remaining repayment of terms and other factors.
            Splash Financial, Inc. (NMLS #1630038), NMLS Consumer Access. Splash® is a registered trademark of Splash Financial, Inc.
            Full disclaimers available here https://splashfinancial.com/disclaimers
        </p>
