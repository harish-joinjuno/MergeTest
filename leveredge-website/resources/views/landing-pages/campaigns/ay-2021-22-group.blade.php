...
@section('content')
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-lg-8 px-lg-5 mb-3 mb-sm-5">
                    <div class="row mb-5">
                        ...
                        <div class="col">
                            <h4 class="mb-3">
                                We’ll have a deal ready for you by late spring! In the meantime, share with your friends to get an even better deal.
                            </h4>
                            ...
                            <div class="row">
                                ...
                                {{--                                <div class="col-6 mb-3">--}}
                                {{--                                    <a--}}
                                {{--                                        href="https://www.facebook.com/dialog/send?app_id=2142075722511834&link={{ urlencode(user()->referral_link) }}"--}}
                                {{--                                        target="_blank"--}}
                                {{--                                        rel="noopener noreferrer"--}}
                                {{--                                        id="messengerButton"--}}
                                {{--                                        class="btn btn-sm btn-block text-white px-0"--}}
                    ...
                    <p>
                        <small>
                            We’ve done this before – three times, in fact. So we’re confident this year
                            our deal will be even better, thanks to you.
                        </small>
                    </p>
                </div>
    ...
    >
        ...
        <div class="container-fluid bg-light-green py-5">
            <div
                class="container bg-white text-center shadow py-5 px-4 px-sm-5 position-relative"
            ...
            >
                ...
                <p>
                    ...
                    We do this by leveraging group buying power. Students who may need loans for Fall 2021 and/or
                    Spring 2022 join the campaign by sharing some basic information about themselves.
                </p>
                <p>
                    Once we have enough voices behind our effort (typically a group of people needing ~$100M of loans),
                    we approach all the lenders and ask them to submit a “bid”. The bid helps us evaluate which
                    lender is offering the most affordable loans.
                </p>
                <p class="mb-5">
                    This campaign is
        ...
        @include('landing-pages.partials._numbered-static-image-text', [
            ...
            participate and our opinions about their interest. ',
        ...
        @include('landing-pages.partials._numbered-static-image-text', [
            ...
            'text' => 'Now that a lender has been selected and the deal has been locked down, we work through the
            details. This typically involves lawyers going through legal documents, the lender inspecting our data
            security and privacy practices, our own due diligence of the lender’s claims (testing their customer
            service wait times, testing their web interface etc).
            <br><br>
        ...
        <div class="container-fluid py-5">
            <div class="container my-5">
                ...
                <p>
                    We do not block people from joining the negotiation group. However, if you are an undergraduate
                    student and don’t have a co-signer, it’s unlikely that you’ll pass the selected lender’s
                    eligibility criteria. (For graduate students, it’s more likely that you qualify but the rates are
                    often better if you have a co-signer).
                </p>
            </div>
        </div>
    </div>
