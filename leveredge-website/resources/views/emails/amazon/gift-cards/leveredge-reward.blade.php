                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                            <tbody><tr>
                                                ...
                                                <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                    ...
                                                    <p><br>
                                                        <span style="color:#2F706B"><strong>Here's your Amazon gift card from Juno!</strong> </span> To redeem, simply enter the code at checkout. Thanks for being a member!</p>
                                                    &nbsp;

                                                    <table align="center" border="0" cellpadding="0" cellspacing="0" style="background-color:#278D87; border:none; border-radius:5px">
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" style="color:#FFFFFF; font-family:Helvetica; font-size:16px; letter-spacing:0.3px; line-height:150%; padding-top:18px; padding-right:50px; padding-bottom:18px; padding-left:50px;" valign="middle"><a href="javascipt:void(0)" style="color:#FFFFFF; text-decoration:none;  font-weight: 550;">{{ $claimCode }}</a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    <br />
