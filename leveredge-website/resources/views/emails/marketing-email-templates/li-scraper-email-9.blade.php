...
@section('content')
    ...
    <p>
        If you have student loans that you’d like to refinance, I’d like to invite you to <a href="https://joinjuno.com/refinance-campaign?utm_source=email&utm_medium=internal_email&utm_campaign=liscrape&utm_term=full_pitch_v1&utm_content=collective_barg_subj">join the group</a> to get access
