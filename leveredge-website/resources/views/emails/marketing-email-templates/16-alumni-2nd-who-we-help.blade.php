...
@section('content')
    ...
    <p>
        Now that interest rates are falling, it’s the perfect time to see if you’re eligible to reduce your debt.
    </p>
    <p>
        We’ve already saved students and alumni across the nation $40M on their student loan debt. Using collective
        bargaining, we negotiate with lenders to reduce interest and fees for our members.
    </p>
    <p>
