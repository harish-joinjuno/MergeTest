...
@section('content')
    ...
    <p>
        As a graduate of {{ $marketingEmail->fields->program }}, I hope you find our service useful. If not, I’d love any feedback you might have.
    </p>
    <p>
        How it works:
    </p>
    ...
    <p>
        If you have student loans that you’d like to refinance, I’d like to invite you to <a href="{{ addUtmCodes(url('/refinance-campaign'), $marketingEmail)  }}">join the group</a> to get access
