...
@section('content')
    ...
    <p>
        We’re so close to finalizing a deal for our members! By adding your name to our list now, you’ll be the first to
        be able to access updates, and learn more about all your options.
    </p>
    <p>
        There’s no cost nor commitment when you <a href="{{ addUtmCodes(url('/'), $marketingEmail) }}">join us now</a>, so don’t wait.
    </p>
    <p>
