...
class RejectedByLenderWithCosignerRule implements MailingListRuleInterface
{
    protected $dealId;
    ...
    public function passes(User $user)
    {
        ...
        if ($hasRejectedByLenderStatuses->count()) {
            ...
            // If there is cosigner this record is eligible for this mailchimp automated campaign
            return $hasCosigner;
        }
