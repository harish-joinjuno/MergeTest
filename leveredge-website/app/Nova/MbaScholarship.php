...
use App\MbaScholarship as MbaScholarshipModel;
...
class MbaScholarship extends Resource
{
    static $group = 'Scholarships';

    public static $model = MbaScholarshipModel::class;
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Select::make('Eligible Gender', 'eligible_gender')
                ->options(MbaScholarshipModel::ELIGIBLE_GENDERS)
                ->nullable(),

            Multiselect::make('Eligible Protected Classes', 'eligible_protected_classes')
                ->options(MbaScholarshipModel::ELIGIBLE_PROTECTED_CLASSES)
                ->nullable()
                ->saveAsJSON(),
            ...
            Multiselect::make('Eligible States', 'eligible_states')
                ->options(MbaScholarshipModel::STATES)
                ->nullable()
                ->saveAsJSON(),
